<template>
  ...
  >
    ...
    <b-button v-if="!product.cart" @click="add(product)"  href="#" variant="primary">Add to  Cart</b-button>
     <b-button v-if="product.cart" @click="add(product)" :disabled="product.cart" href="#" variant="warning"> added to Cart </b-button>
  </b-card>
    </b-col>
  </b-row>
